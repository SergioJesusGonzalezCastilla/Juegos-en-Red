...
public class User {
	...
	private boolean registrado; //Booleano en que se indicará si el usuario ya forma parte del sistema
	...
	public User(String nombre_usuario, String password_usuario)
	{
		...
		//Asignaremos un valor por defecto al parámetro registrado
		registrado=false;
	}
