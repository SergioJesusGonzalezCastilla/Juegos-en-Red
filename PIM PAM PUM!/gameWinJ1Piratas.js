var sonidoFondoG1;
var sonidoDisparo;
 export class gameWinJ1Piratas extends Phaser.Scene{

    constructor(){
        super({key:'winJ1Piratas'});
    }

    preload(){

        //FONDO
        this.load.image('GanaPirata1', 'resources/Piratas/GanaPirata1.png')
    ...
    create(){
        ...
        this.add.image(1280/2, 720/2, 'GanaPirata1');  
