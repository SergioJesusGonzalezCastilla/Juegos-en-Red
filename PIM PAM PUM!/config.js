...
const config = {
    ...
    scene:[Minicio,Meme,Modificar,ModoCliente,Registro,Ajustes,Opciones,Mapas,Seleccion,Simulador,Creditos,Game,gamePiratas,Game_Online,Pausa,gameWinJ1,gameWinJ2,gameWinJ1Piratas,gameWinJ2Piratas],
